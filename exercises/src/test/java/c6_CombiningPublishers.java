...
//        currentUserMono.subscribe(this::getUserEmail);
//        getUserEmail(null);
    ...
    public void streaming_service() {
        //todo: feel free to change code as you need
        Flux<Message> messageFlux = streamingService().flatMapMany(t -> t);
//        streamingService();
//        Mono.just(Flux.just(1,2,4)).flatMapMany(x -> x).subscribe(System.out::println);
        //don't change below this line
